...
create_mw_lib -technology $mw_tech_file -mw_reference_library $mw_reference_library ROB_design      
open_mw_lib ROB_design
...
read_file {../../src/onlyv/.} -autoread -recursive -top ROB
#elaborate pipelined
...
set_driving_cell -lib_cell INVD1 clk_i 
set_driving_cell -lib_cell INVD1 decodeReadAddr1_i
set_driving_cell -lib_cell INVD1 decodeReadAddr2_i
set_driving_cell -lib_cell INVD1 updateTail_i
set_driving_cell -lib_cell INVD1 decodeWriteData_i
set_driving_cell -lib_cell INVD1 completionWriteAddr_i
set_driving_cell -lib_cell INVD1 completionWriteEn_i
set_driving_cell -lib_cell INVD1 completionWriteData_i
set_driving_cell -lib_cell INVD1 updateHead_i


# set_load for outputs
set_load [load_of tcbn65gpluswc0d72_ccs/INVD1/I] [get_ports decodeReadData1_o]
set_load [load_of tcbn65gpluswc0d72_ccs/INVD1/I] [get_ports decodeReadData2_o]
set_load [load_of tcbn65gpluswc0d72_ccs/INVD1/I] [get_ports nextTail_o]
set_load [load_of tcbn65gpluswc0d72_ccs/INVD1/I] [get_ports stall_o]
set_load [load_of tcbn65gpluswc0d72_ccs/INVD1/I] [get_ports head_o]
set_load [load_of tcbn65gpluswc0d72_ccs/INVD1/I] [get_ports commitReadData_o]

#connect referenced library components to the current design
link

#Define design constraints
set_max_transition 0.1 [get_designs ROB]
set_max_fanout 6 ROB
create_clock -name "clk" -period 20 -waveform {0 1} [get_ports clk_i]
set_clock_uncertainty -setup 2 clk
set_clock_uncertainty -hold 0.01 clk
set_clock_transition 0.05 [get_clocks]
set_input_delay 0.1 -clock clk [remove_from_collection [all_inputs] [get_ports clk_i]]
set_fix_hold {clk}
...
file mkdir reports
report_power > reports/ROB.power
report_constraint -verbose > reports/ROB.constraint
report_constraint -all_violators > reports/ROB.violation
write_sdc  reports/ROB.sdc
file mkdir db
write -h ROB -output ./db/ROB.db
write_sdf -context verilog -version 1.0 reports/ROB.sdf
file mkdir netlist
write -h -f verilog ROB -output netlist/ROB.sv -pg
file mkdir ddc
