...
# DVE full session
# Saved on Sun May 6 16:35:23 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{65 80} {1894 998}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 479} {height 683} {dock_state left} {dock_on_new_line true} {child_hier_colhier 418} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 216} {height 683} {dock_state left} {dock_on_new_line true} {child_data_colvariable 163} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 155]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1830
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 155
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1829} {height 154} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_1" { tb.clk tb.reset tb.ClockDelay }
gui_set_radix -radix {decimal} -signals {V1:tb.ClockDelay}
gui_set_radix -radix {twosComplement} -signals {V1:tb.ClockDelay}
