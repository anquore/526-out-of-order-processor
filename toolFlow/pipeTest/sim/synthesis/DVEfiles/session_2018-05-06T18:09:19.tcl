...
# DVE full session
# Saved on Sun May 6 18:09:19 2018
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{65 80} {1891 995}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 476} {height 683} {dock_state left} {dock_on_new_line true} {child_hier_colhier 418} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 213} {height 683} {dock_state left} {dock_on_new_line true} {child_data_colvariable 163} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1826} {height 151} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_1" { tb.dut.theDataPath.regStuff.theReg.bankODFFs.dataOut }
gui_set_radix -radix {decimal} -signals {V1:tb.dut.theDataPath.regStuff.theReg.bankODFFs.dataOut}
gui_set_radix -radix {unsigned} -signals {V1:tb.dut.theDataPath.regStuff.theReg.bankODFFs.dataOut}
